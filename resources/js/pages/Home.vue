...
import { Library, MessageSquare, Megaphone } from 'lucide-vue-next'
  ...
  <GuestLayout>
    ...
    <ContentContainer>
      ...
      <div class="grid md:grid-cols-3 gap-8">
        ...
        >
          <div class="w-16 h-16 bg-blue-600 text-white rounded-lg flex items-center justify-center mb-6">
            <component :is="getIconComponent(approach.icon)" class="w-8 h-8" />
          </div>
      ...
      <div class="rounded-2xl overflow-hidden my-12">
        <div
          style="background-image: url('/images/about-alliance.jpg')"
